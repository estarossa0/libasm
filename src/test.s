...
Lcfi2:
	...
	xor	eax, eax
Ltmp0:
	.loc	1 14 3 prologue_end     ## test.c:14:3
	mov	rcx, qword ptr [rbp - 8]
	.loc	1 14 7 is_stmt 0        ## test.c:14:7
	mov	qword ptr [rcx], 0
	.loc	1 15 1 is_stmt 1        ## test.c:15:1
	pop	rbp
	ret
Ltmp1:
Lfunc_end0:
...
Linfo_string:
	...
	.asciz	"/Users/arraji/Desktop/asm" ## string offset=51
	.asciz	"main"                  ## string offset=77
	.asciz	"int"                   ## string offset=82
	.asciz	"ptr"                   ## string offset=86
	.asciz	"sub"                   ## string offset=90
...
Lset3 = Lfunc_end0-Lfunc_begin0         ## DW_AT_high_pc
	...
	.long	104                     ## DW_AT_type
	.byte	4                       ## Abbrev [4] 0x52:0xe DW_TAG_variable
	.byte	2                       ## DW_AT_location
	.byte	145
	.byte	112
	.long	90                      ## DW_AT_name
	...
	.byte	6                       ## Abbrev [6] 0x68:0x5 DW_TAG_pointer_type
	.long	42                      ## DW_AT_type
	.byte	0                       ## End Of Children Mark
